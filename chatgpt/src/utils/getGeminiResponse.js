...
exports.genTopic = exports.initChat = void 0;
...
var ai = new genai_1.GoogleGenAI({ apiKey: import.meta.env.VITE_GEMINI_API_KEY });
var chat = null;
function initChat() {
...
function getGeminiResponse(message) {
    return __asyncGenerator(this, arguments, function getGeminiResponse_1() {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    if (!chat)
                        initChat();
                    return [4 /*yield*/, __await(chat.sendMessageStream({ message: message }))];
                case 1:
                    stream = _e.sent();
                    _e.label = 2;
                case 2:
...
exports.default = getGeminiResponse;
function genTopic(text) {
